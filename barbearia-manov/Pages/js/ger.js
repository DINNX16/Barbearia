const availableIcons = [
    ...
    '../assets/icones_tela_avisos/aviso_urgente.png',
    '../assets/icones_tela_avisos/horario.png',
    '../assets/icones_tela_avisos/cortes.png',
    '../assets/icones_tela_avisos/new.png',
...
avisoForm.addEventListener('submit', (e) => {
    ...
    if (id) {
        ...
        if (index !== -1) {
            ...
            showNotificationModal('Aviso atualizado com sucesso!');
        }
    } else {
        ...
        showNotificationModal('Aviso adicionado com sucesso!');
    }
...
function deleteAviso(id) {
    showConfirmationModal('Tem certeza que deseja excluir este aviso?', () => {
        avisosData = avisosData.filter(a => a.id !== id);
        renderAvisosTable();
        showNotificationModal('Aviso excluído com sucesso!');
        clearForm();
    });
}
